package com.kumanchu.crafttreeplanner.integration.jei;
...
@JeiPlugin
public class CraftTreeJeiPlugin implements IModPlugin, IGlobalGuiHandler {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("crafttreeplanner", "jei_plugin");
    ...
    public Optional<? extends IClickableIngredient<?>> getClickableIngredientUnderMouse(IClickableIngredientFactory factory, double mouseX, double mouseY) {
        try {
            ...
            if (s instanceof CraftTreeScreen treeScreen) {
