...
import com.kumanchu.crafttreeplanner.core.crafting.DirectCraftingEngine;
...
public class CraftTreeNetwork {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        CraftTreePlanner.LOGGER.info("[CraftTreePlanner] Network payloads registered successfully.");
    }
