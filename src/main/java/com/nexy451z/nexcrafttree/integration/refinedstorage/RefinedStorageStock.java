...
public class RefinedStorageStock implements IStockProvider {
    ...
    public long getAmount(ItemStack stack) {
        try {
            ...
            NexCraftTree.LOGGER.debug("[NexCraftTree] RS stock query failed: {}", t.toString());
            return 0;
        }
    }
     ...
     */
    public static List<com.nexy451z.nexcrafttree.core.stock.StaticStockProvider.Entry> captureEntries() {
        try {
            Minecraft mc = Minecraft.getInstance();
            ...
            List<com.nexy451z.nexcrafttree.core.stock.StaticStockProvider.Entry> out = new java.util.ArrayList<>();
